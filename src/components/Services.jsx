        ...
        <div className="bento-grid">
          ...
          <TiltCard className="bento-item bento-large fade-in">
            <div className="bento-content">
              <svg viewBox="0 0 24 24" fill="none" stroke="var(--accent-color)" strokeWidth="1" width="48" height="48" style={{ marginBottom: '20px' }}><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
          ...
          <TiltCard className="bento-item fade-in delay-1">
            <div className="bento-content">
              <svg viewBox="0 0 24 24" fill="none" stroke="var(--accent-color)" strokeWidth="1" width="40" height="40" style={{ marginBottom: '15px' }}><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
          ...
          <TiltCard className="bento-item fade-in delay-2">
            <div className="bento-content">
              <svg viewBox="0 0 24 24" fill="none" stroke="var(--accent-color)" strokeWidth="1" width="40" height="40" style={{ marginBottom: '15px' }}><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>
