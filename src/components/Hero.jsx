  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="container hero-content" style={{ position: 'relative', zIndex: 10, pointerEvents: 'none', maxWidth: '1200px', width: '100%', userSelect: 'none' }}>
        <h1 className="fade-in" style={{ pointerEvents: 'auto', textAlign: 'left', marginBottom: '2rem' }}>Creamos el Software<br/>del Futuro para<br/>Tu Empresa.</h1>
        ...
        <div className="hero-stats fade-in delay-2" style={{ display: 'flex', justifyContent: 'flex-start', gap: '4rem', pointerEvents: 'auto', marginTop: '5rem' }}>
          <div className="stat-item">
            <h2 style={{ fontSize: '3.5rem', color: 'var(--accent-color)', margin: 0, lineHeight: 1 }}>+45</h2>
          ...
          <div className="stat-item">
            <h2 style={{ fontSize: '3.5rem', color: 'var(--accent-color)', margin: 0, lineHeight: 1 }}>99%</h2>
          ...
          <div className="stat-item">
            <h2 style={{ fontSize: '3.5rem', color: 'var(--accent-color)', margin: 0, lineHeight: 1 }}>10+</h2>
